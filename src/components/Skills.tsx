        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 animate-slide-in-up">
            {skillCategories.map((category, categoryIndex) => (
              <div
                key={categoryIndex}
                className="sci-fi-border backdrop-blur-sm p-6 hover:border-blue-400/50 transition-all duration-300 hover-lift"
                style={{ animationDelay: `${categoryIndex * 0.3}s` }}
              >
                <h3 className="text-xl font-semibold text-white mb-6 text-center transition-all duration-300 hover:text-blue-400">
                  {category.title}
                </h3>
          ...
          <div className="mt-12 text-center">
            <div className="inline-block sci-fi-border backdrop-blur-sm p-4 font-mono text-sm hover-lift animate-fade-in">
              ...
              <div className="text-green-400">
                const learning = [<span className="text-blue-400">"GraphQL"</span>, <span className="text-blue-400">"Kubernetes"</span>, <span className="text-blue-400">"Machine Learning"</span>];
              </div>
